...
**(12)** Next is something that will show how powerful these protocols really are. Extend the `AdvisoryBoardMember` struct and adopt the following protocols in this extension.  
